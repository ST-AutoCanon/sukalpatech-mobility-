import { Package, Truck, Wrench, FileText, ShieldCheck, Boxes } from "lucide-react";
    ...
    <section className="bg-[#F8FAFC]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <div className="w-24 h-1 bg-[#7BAF2A] mx-auto mt-4 rounded-full"></div>
        </div>
...
<div className="bg-white py-20 px-6">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="text-center max-w-5xl mx-auto">
      ...
      <div className="w-24 h-1 bg-[#7BAF2A] mx-auto mt-5 rounded-full"></div>
  ...
  <div className="w-20 h-1 bg-[#7BAF2A] mx-auto mt-4 rounded-full"></div>
</div>
  ...
  {documentationServices.map((service, index) => (
    ...
    >
      <div className="w-14 h-14 rounded-full bg-[#7BAF2A]/10 flex items-center justify-center mb-5">
        <FileText className="w-7 h-7 text-[#7BAF2A]" />
      </div>
